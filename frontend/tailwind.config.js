...
module.exports = {
  content: [
    ...
    './apps/**/app/**/*.{js,ts,jsx,tsx,html}',
    './apps/**/pages/**/*.{js,ts,jsx,tsx,html}',
    './apps/**/components/**/*.{js,ts,jsx,tsx,html}',
    './packages/**/src/**/*.{js,ts,jsx,tsx,html}',
    './packages/**/components/**/*.{js,ts,jsx,tsx,html}',
  ],
  darkMode: 'class',
  presets: [require('./packages/ui-kit/tailwind-preset.js')],
  theme: {
    extend: {
      colors: {
        brand: {
