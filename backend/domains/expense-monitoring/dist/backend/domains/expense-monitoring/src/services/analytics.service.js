...
let AnalyticsService = class AnalyticsService {
    async getSpendingTrends(period, category) {
        const baseData = [
    ...
    async getCostCenterAnalysis(period) {
    ...
    async getFinancialForecasting(months) {
    ...
    generateForecast(historicalData, months) {
    ...
    generateDetailedForecast(historicalData, months) {
    ...
    getSeasonalAdjustment(month) {
        const seasonalFactors = [
            1.05, 0.95, 1.10, 1.08, 0.98, 1.02,
            0.92, 0.88, 1.15, 1.12, 1.08, 1.25
        ];
