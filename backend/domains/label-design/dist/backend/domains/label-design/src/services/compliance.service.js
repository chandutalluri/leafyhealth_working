...
let ComplianceService = class ComplianceService {
    ...
    async checkAllergenCompliance(productId, allergens) {
        ...
        const validAllergens = allergens.filter(allergen => commonAllergens.includes(allergen.toLowerCase()));
        const invalidAllergens = allergens.filter(allergen => !commonAllergens.includes(allergen.toLowerCase()));
        return {
            productId,
