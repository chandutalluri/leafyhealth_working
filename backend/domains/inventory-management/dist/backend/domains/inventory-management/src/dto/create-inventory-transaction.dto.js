...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Transaction type', enum: ['IN', 'OUT', 'ADJUSTMENT'] }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsIn)(['IN', 'OUT', 'ADJUSTMENT']),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Unit cost', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateInventoryTransactionDto.prototype, "unitCost", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Reference (PO, SO, etc.)', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
