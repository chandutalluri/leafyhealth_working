...
exports.orders = (0, pg_core_1.pgTable)('orders', {
    ...
    deliveryBundle: (0, pg_core_1.varchar)('delivery_bundle', { length: 100 }),
    retryCount: (0, pg_core_1.integer)('retry_count').default(0),
    lastRetryAt: (0, pg_core_1.timestamp)('last_retry_at'),
    originalOrderId: (0, pg_core_1.integer)('original_order_id'),
    partialOrderId: (0, pg_core_1.integer)('partial_order_id'),
    fulfillmentCenter: (0, pg_core_1.varchar)('fulfillment_center', { length: 100 }),
    estimatedDeliveryTime: (0, pg_core_1.varchar)('estimated_delivery_time', { length: 50 }),
    routingScore: (0, pg_core_1.decimal)('routing_score', { precision: 3, scale: 2 }),
