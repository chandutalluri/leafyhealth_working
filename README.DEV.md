...
📋 **CRITICAL:** See `COMPOSITE_BUSINESS_DOMAIN_ARCHITECTURE.md` for complete implementation guidelines of the new business domain architecture.
...
frontend/
  apps/
    ...
    super-admin/          # Global admin for entire platform
...
server/
  api-gateway/            # Central Public API gateway (port 8080)
  internal-gateway/       # Internal API proxying with auth (port 8084)
...
✅ Use /api via centralized gateway (http://localhost:8080 only)
